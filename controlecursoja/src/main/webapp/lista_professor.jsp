...
<input type="reset" value="Limpar" />
 ...
 <td><a href="IniciarAlterarProfessor?id=<%= p.getId()%>">Alterar</a> 
 <a href="ExcluirProfessor?id=<%= p.getId() %>" onclick="return confirm('Deseja excluir este professor?')">Excluir</a></td>
 </tr>
 <% } %>
 </tbody>
 </table>
